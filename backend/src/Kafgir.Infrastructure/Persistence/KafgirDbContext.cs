...
namespace Kafgir.Infrastructure.Persistence;

public sealed class KafgirDbContext(DbContextOptions<KafgirDbContext> options)
    : IdentityDbContext<ApplicationUser, IdentityRole<int>, int>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(KafgirDbContext).Assembly);
    }
}
